...
void main() {
  ...
  test('test if verify code is ok ', () async {
    var res = await accountingApi.verifyPhone(
        phone: "09366", uid: "testFromMacFlutter", code: "7600");
    expect(res.state.error, equals(3));
  });
  ...
  //   {
  //     expect(res.swimTypes.length, greaterThan(3));
  //
  //   }else{
  //     expect(1, equals(0));
  //   }
  ...
  //   });
  //
  //   // var response = await client.post(Uri.http('sai.com', '/foo'),
