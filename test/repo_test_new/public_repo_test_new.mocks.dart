...
import 'package:alpha/back/public_repo/models/top_swimmers/top_swimmers_result.dart'
    as _i5;
import 'package:alpha/back/public_repo/public_apis.dart' as _i6;
...
class MockPublicApis extends _i1.Mock implements _i6.PublicApis {
  MockPublicApis() {
  ...
  @override
  _i7.Future<_i3.AlphaClubResult> getAlphaClub({String? uid = r'-1'}) =>
      (super.noSuchMethod(Invocation.method(#getAlphaClub, [], {#uid: uid}),
              returnValue:
                  Future<_i3.AlphaClubResult>.value(_FakeAlphaClubResult_1()))
          as _i7.Future<_i3.AlphaClubResult>);
  @override
  _i7.Future<_i4.GalleryResult> getGallery({String? uid = r'-1'}) =>
      (super.noSuchMethod(Invocation.method(#getGallery, [], {#uid: uid}),
              returnValue:
                  Future<_i4.GalleryResult>.value(_FakeGalleryResult_2()))
          as _i7.Future<_i4.GalleryResult>);
  @override
  _i7.Future<_i5.TopSwimmersResult> getTopSwimmers({String? uid = r'-1'}) =>
      (super.noSuchMethod(Invocation.method(#getTopSwimmers, [], {#uid: uid}),
          ...
          as _i7.Future<_i5.TopSwimmersResult>);
  @override
